(this.workbox = this.workbox || {}),
  (this.workbox.expiration = (function (t, e, s, i, a, n) {
    "use strict";
    try {
    ...
    class o {
      constructor(t) {
        (this.t = t),
          (this.s = new e.DBWrapper(h, 1, {
            onupgradeneeded: (t) => this.i(t),
          }));
      }
      i(t) {
        const e = t.target.result.createObjectStore(c, { keyPath: "id" });
    ...
    return (
      ...
      (t.Plugin = class {
        ...
        k(t) {
          if (t === a.cacheNames.getRuntimeName())
            throw new i.WorkboxError("expire-custom-caches-only");
          let e = this.g.get(t);
        ...
        async cacheDidUpdate({ cacheName: t, request: e }) {
          const s = this.k(t);
