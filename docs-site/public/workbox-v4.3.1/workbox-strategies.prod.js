  ...
  (this.workbox.strategies = (function (e, t, s, n, r) {
    ...
    class i {
      ...
      async handle({ event: e, request: t }) {
        return this.makeRequest({ event: e, request: t || e.request });
      }
      async makeRequest({ event: e, request: t }) {
        ...
        if (!i)
          throw new r.WorkboxError("no-response", { url: t.url, error: n });
        return i;
      }
      async u(e, t) {
    ...
    class h {
      ...
      async makeRequest({ event: e, request: t }) {
        ...
        if (!n) throw new r.WorkboxError("no-response", { url: t.url });
        return n;
      }
    }
    const u = {
    ...
    class a {
      ...
      async makeRequest({ event: e, request: t }) {
        ...
        const h = this.q({ timeoutId: i, request: t, event: e, logs: s });
        n.push(h);
        let u = await Promise.race(n);
        if ((u || (u = await h), !u))
          throw new r.WorkboxError("no-response", { url: t.url });
        return u;
      }
      ...
      async q({ timeoutId: e, request: t, logs: r, event: i }) {
        ...
        if ((e && clearTimeout(e), h || !u))
          u = await this.p({ request: t, event: i });
        else {
          const e = u.clone(),
    ...
    class c {
      ...
      async makeRequest({ event: e, request: t }) {
        ...
        if (!i)
          throw new r.WorkboxError("no-response", { url: t.url, error: s });
        return i;
      }
    }
    class o {
      ...
      async makeRequest({ event: e, request: t }) {
        "string" == typeof t && (t = new Request(t));
        const n = this.u({ request: t, event: e });
        let i,
        ...
        if (!h)
          throw new r.WorkboxError("no-response", { url: t.url, error: i });
        return h;
      }
