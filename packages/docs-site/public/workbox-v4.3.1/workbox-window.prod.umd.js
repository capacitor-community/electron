  ...
  var f = (function (n) {
    ...
    return (
              ...
              a(e.O(), function (n) {
                ...
                return (
                  ...
                  "BroadcastChannel" in self &&
                    ((e.B = new BroadcastChannel("workbox")),
                    e.B.addEventListener("message", e.v)),
      ...
      (g.g = function () {
        ...
        this.o > 0 ||
        !o(n.scriptURL, this.t) ||
        performance.now() > this.C + 6e4
        ...
        !r && this.p && (s.isUpdate = !0),
          ...
          "installed" === e
            ? (this.W = setTimeout(function () {
                "installed" === e &&
                  t.R.waiting === i &&
                  t.dispatchEvent(new u(o + "waiting", s));
              }, 200))
            : "activating" === e &&
              (clearTimeout(this.W), r || this.s.resolve(i));
      }),
      (g.m = function (n) {
        var t = this._;
        t === navigator.serviceWorker.controller &&
          (this.dispatchEvent(
            new u("controlling", { sw: t, originalEvent: n })
          ),
          this.h.resolve(t));
      }),
      (g.v = function (n) {
