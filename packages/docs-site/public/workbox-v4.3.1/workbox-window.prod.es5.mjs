  ...
  return (
    (d.register = u(function (n) {
      ...
      return (
              ...
              return (
                t &&
                  ...
                  Promise.resolve().then(function () {
                    e.dispatchEvent(
                      new o("waiting", { sw: t, wasWaitingBeforeRegister: !0 })
                    );
                  })),
                e.O && e.u.resolve(e.O),
                e.B.addEventListener("updatefound", e.g),
                ...
                "BroadcastChannel" in self &&
                  ((e.C = new BroadcastChannel("workbox")),
                  e.C.addEventListener("message", e.v)),
        ...
        (i = (function () {
          if (!c && "complete" !== document.readyState)
            return (function (n, t) {
    ...
    (d.j = function (t) {
      n(t, { type: "WINDOW_READY", meta: "workbox-window" });
    }),
    (d.g = function () {
      var n = this.B.installing;
      this.o > 0 || !r(n.scriptURL, this.t) || performance.now() > this.L + 6e4
        ? ((this.W = n), this.B.removeEventListener("updatefound", this.g))
        : ((this.O = n), this.u.resolve(n)),
        ++this.o,
    ...
    (d.l = function (n) {
      var t = this,
        ...
        r = i === this.W,
        u = r ? "external" : "",
        a = { sw: i, originalEvent: n };
      !r && this.p && (a.isUpdate = !0),
        this.dispatchEvent(new o(u + e, a)),
        "installed" === e
          ? (this._ = setTimeout(function () {
              "installed" === e &&
                t.B.waiting === i &&
                t.dispatchEvent(new o(u + "waiting", a));
            }, 200))
          : "activating" === e &&
    ...
    (d.m = function (n) {
      ...
      t === navigator.serviceWorker.controller &&
        (this.dispatchEvent(new o("controlling", { sw: t, originalEvent: n })),
        this.h.resolve(t));
    }),
    (d.v = function (n) {
      var t = n.data;
      this.dispatchEvent(new o("message", { data: t, originalEvent: n }));
    }),
    (l = v),
    (w = [
      {
  ...
  (function () {
    ...
    return (
      ...
      (t.dispatchEvent = function (n) {
        (n.target = this),
          this.T(n.type).forEach(function (t) {
            return t(n);
          });
      }),
      (t.T = function (n) {
...
export { c as Workbox, n as messageSW };
