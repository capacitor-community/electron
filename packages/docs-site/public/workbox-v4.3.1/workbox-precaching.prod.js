(this.workbox = this.workbox || {}),
  (this.workbox.precaching = (function (t, e, n, s, c) {
    "use strict";
    try {
    ...
    function r(t) {
      if (!t)
        throw new c.WorkboxError("add-to-cache-list-unexpected-type", {
          entry: t,
        });
      if ("string" == typeof t) {
      ...
      return o.searchParams.set(a, e), { cacheKey: o.href, url: s.href };
    }
    class l {
      constructor(t) {
      ...
      addToCacheList(t) {
        for (const e of t) {
          const { cacheKey: t, url: n } = r(e);
          if (this.s.has(n) && this.s.get(n) !== t)
            throw new c.WorkboxError("add-to-cache-list-conflicting-entries", {
      ...
      async install({ event: t, plugins: e } = {}) {
        ...
        const a = n.map((n) => this.o({ event: t, plugins: e, url: n }));
        return await Promise.all(a), { updatedURLs: n, notUpdatedURLs: s };
      }
      async activate() {
      ...
      async o({ url: t, event: e, plugins: o }) {
        const i = new Request(t, { credentials: "same-origin" });
        let a,
          r = await s.fetchWrapper.fetch({ event: e, plugins: o, request: i });
        for (const t of o || [])
          "cacheWillUpdate" in t && (a = t.cacheWillUpdate.bind(t));
        if (!(a ? a({ event: e, request: i, response: r }) : r.status < 400))
          throw new c.WorkboxError("bad-precaching-response", {
            url: t,
            status: r.status,
          });
        r.redirected &&
      ...
      for (const s of (function* (
        ...
        const i = (function (t, e) {
          for (const n of [...t.searchParams.keys()])
            e.some((t) => t.test(n)) && t.searchParams.delete(n);
          return t;
        })(o, e);
    ...
    const f = (t) => {
      ...
      y = (t) => {
        const e = h(),
          n = i.get();
        t.waitUntil(
          e.install({ event: t, plugins: n }).catch((t) => {
            throw t;
          })
        );
      },
      p = (t) => {
        const e = h(),
          n = i.get();
        t.waitUntil(e.activate({ event: t, plugins: n }));
      },
      L = (t) => {
        h().addToCacheList(t),
          t.length > 0 &&
            (addEventListener("install", y), addEventListener("activate", p));
      };
    return (
      (t.addPlugins = (t) => {
        i.add(t);
      ...
      (t.cleanupOutdatedCaches = () => {
        addEventListener("activate", (t) => {
          ...
          t.waitUntil(
            (async (t, e = "-precache-") => {
              const n = (await caches.keys()).filter(
                (n) =>
                  n.includes(e) &&
